  ...
  <div class="login-box shadow-lg rounded overflow-hidden w-100" style="max-width: 950px;">
    ...
    <div class="login-body d-flex">
      ...
      <div class="form-section p-4 flex-fill" style="flex:0.55; max-width:520px;">
        <h3 class="fw-bold mb-2 text-center">Welcome! Admin</h3>
        <p class="text-muted mb-4 text-center">Sign up to Manage Sistem</p>

        <?php if (isset($_GET['error'])): ?>
          <div class="alert alert-danger py-2"><?= htmlspecialchars($_GET['error']); ?></div>
        <?php endif; ?>

        <form action="../../../backend/admin/auth/register_process.php" method="POST" class="row g-3">
          <!-- Nama Lengkap -->
          <div class="col-md-6">
      ...
      <!-- Right Illustration -->
      <div class="illustration-section d-none d-md-flex flex-fill justify-content-center align-items-center bg-white p-4" style="flex:0.45;">
