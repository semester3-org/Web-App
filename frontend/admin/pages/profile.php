...
$profilePicPath = !empty($user['profile_picture']) && file_exists("../../../uploads/profiles/" . $user['profile_picture']) 
...
<body>
        ...
        <div class="profile-avatar-container">
          <div class="profile-avatar" id="avatarContainer">
            <?php if ($profilePicPath): ?>
              <img src="<?= htmlspecialchars($profilePicPath) ?>" alt="Profile Picture" id="currentAvatar">
            <?php else: ?>
  ...
  <script>
    ...
    function uploadProfilePicture() {
      ...
      fetch('../../../backend/admin/classes/upload_profile_picture.php', {
        method: 'POST',
        body: formData
      })
      .then(res => res.json())
