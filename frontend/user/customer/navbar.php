    ...
    <div class="d-flex align-items-center">
      ...
      <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-dark text-decoration-none"
           ...
           aria-expanded="false">
          <img src="../assets/profile.jpg" alt="profile" class="rounded-circle" style="height:35px; width:35px; object-fit:cover;">
        </a>
        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="profileDropdown">
          <li><a class="dropdown-item" href="settings.php"><i class="bi bi-person-circle me-2"></i> Profile</a></li>
