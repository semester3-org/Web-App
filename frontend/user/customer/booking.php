...
<body>
                ...
                <div class="d-flex flex-column align-items-end gap-1">
                  ...
                  <?php if (isset($booking['payment_status']) && $booking['status'] === 'confirmed'): ?>
                    <span class="badge bg-<?php
                                          echo $booking['payment_status'] === 'paid' ? 'success' : ($booking['payment_status'] === 'pending' ? 'warning' : 'secondary');
                                          ?>">
                      <?php
                      $payment_labels = [
                        'unpaid' => 'Belum Bayar',
  ...
  console.log('Fetching to:', apiUrl); // DEBUG LOG
  ...
  fetch(apiUrl, {
    ...
    function checkPaymentStatus(bookingId) {
      Swal.fire({
        ...
        text: 'Pembayaran Anda sedang diproses. Silakan selesaikan pembayaran atau tunggu konfirmasi.',
