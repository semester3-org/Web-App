...
<body>
    ...
    <!-- Navbar -->
    <?php include($_SERVER['DOCUMENT_ROOT'] . "/frontend/user/customer/navbar.php"); ?>
    <br>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <a href="/frontend/user/customer/explore.php" class="btn btn-light btn-lg">Jelajahi Kost Sekarang</a>

            <div class="hero-thumbnails">
                <div class="thumbnail-item" data-bg="/frontend/assets/bg_home1.jpg"></div>
                <div class="thumbnail-item" data-bg="/frontend/assets/bg_home3.jpg"></div>
                <div class="thumbnail-item" data-bg="/frontend/assets/bg_home2.jpg"></div>
                <div class="thumbnail-item" data-bg="/frontend/assets/bg_home4.jpg"></div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            ...
            <p>Dibangun dengan love untuk mahasiswa Indonesia</p>
            <div class="social">
    ...
    <!-- Script Pergantian Background Hero -->
    <script>
    ...
    <!-- Script Navbar Scroll Effect (opsional, tapi biasanya kamu pakai) -->
    <script>
