...
/**
 * Property Approval Process Backend with Pagination
...
<<<<<<< HEAD
            ...
            // Get total count
            $total = $this->getTotalProperties($status);
...
>>>>>>> 99e59ed2a7a58e7bbee6bf1838809084885d5afc
    ...
    /**
     * Get total properties count by status
     */
    private function getTotalProperties($status = 'pending') {
        try {
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action'])) {
    ...
    switch ($action) {
        case 'get_properties':
            ...
            $result = $approvalProcess->getPropertiesByStatus($status, $page, $limit);
